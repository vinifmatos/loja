class Admin::ProdutosController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @produto.save
        format.html { redirect_to [:admin, @produto], notice: 'Produto was successfully created.' }
        format.json { render :show, status: :created, location:[:admin, @produto] }
      else
  ...
  def update
    respond_to do |format|
      if @produto.update(produto_params)
        format.html { redirect_to [:admin, @produto], notice: 'Produto was successfully updated.' }
        format.json { render :show, status: :ok, location: [:admin, @produto] }
      else
